...
const FAQ_ITEMS = [
  ...
  { q: 'Can students access unpublished courseware?', a: 'No. Students only see items published to their block. Draft and finalized-but-unpublished items stay visible to the instructor only.' },
